    ...
    public static void agentmain(String args, Instrumentation inst) {
        try {
            ...
            try {
                ...
                System.out.println("[RPL30] 回放已加载");
            } catch (Throwable t) {
                System.out.println("[RPL30] loadReplay 失败:"); t.printStackTrace(System.out);
            }
            // 2. 投递采样任务
            Field qf = null;
            ...
            q.add(c.newInstance(new ReplaySampleTask3()));
            System.out.println("[RPL30] 采样任务已投递");
