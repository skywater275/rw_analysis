...
public class AISandboxTask implements Runnable {
    public String map;
    public Object gui;
    public Object libB;
        ...
        try {
            ...
            if (bQ != null) {
                for (Field f : bQ.getClass().getFields()) {
                    if (f.getName().equals("aiDifficulty")) { f.set(bQ, 1); break; }  // v19.113s: 难度1 (实时AI行为)
                }
            }
            ...
            iCls.getMethod("a", String.class, boolean.class, int.class, int.class, boolean.class, boolean.class)
                    .invoke(null, map, skirmish, 1, 0, true, false);  // v19.113s: ais=1 AI 对手 (实时 AI 行为采样)
