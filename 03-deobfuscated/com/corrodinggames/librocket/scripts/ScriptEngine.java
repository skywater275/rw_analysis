...
import com.corrodinggames.librocket.scripts.DebugUIUI;
...
public class ScriptEngine {
    LibRocketBridge slickLibRocket;
    private MainUIController root;
    ...
    public static boolean isStrict() {
        return com.corrodinggames.rts.gameFramework.commands.DebugServer.c;
    }

    public static void checkThreadAccess() {
        if (!((Boolean)isMainScriptThread.get()).booleanValue()) {
            GlobalState.b("ScriptEngine: thread is not marked as main script thread!");
            GlobalState.T();
        }
    }

    public MainUIController getRoot() {
        ScriptEngine.checkThreadAccess();
        return this.root;
    }

    public MainUIController getRootNoCheck() {
        return this.root;
    }
    ...
    public static ScriptEngine createScriptEngine(LibRocketBridge b2) {
    ...
    private ScriptEngine(LibRocketBridge b2) {
        this.slickLibRocket = b2;
        this.root = new MainUIController();
        this.setupScriptContext(this.root);
        this.setGlobalVariable("root", this.root);
        MultiplayerUI multiplayer = new MultiplayerUI(this.root);
        ...
        ModsUI mods = new ModsUI(this.root);
        ...
        if (com.corrodinggames.rts.gameFramework.commands.DebugServer.c) {
            DebugUI debug = new DebugUI(this.root);
    ...
    public void setupScriptContext(ScriptContext scriptContext) {
        ...
        scriptContext.guiEngine = com.corrodinggames.librocket.LibRocketContext.a();
    ...
    public void update(float f2) {
        ...
        if (this.queuedScripts.size() != 0) {
            ...
            synchronized (arrayList) {
                java.util.Iterator object = this.queuedScripts.iterator();
    ...
    public ScriptEngine$Action addScriptToQueueIfNotAlreadyQueued(String string) {
        ArrayList arrayList = this.queuedScripts;
        synchronized (arrayList) {
            for (java.util.Iterator iterator = this.queuedScripts.iterator(); iterator.hasNext();) {
                ScriptEngine$Action scriptEngine$Action = (ScriptEngine$Action)iterator.next();
    ...
    public static void throwDelayedException(String string, Throwable throwable) {
        GlobalState.a("throwDelayedException", throwable);
        if (scriptError == null) {
    ...
    public Object processArg(String string) {
        ...
        if (matcher != null) {
            return com.corrodinggames.rts.gameFramework.GameUtils.unescapeHtml(matcher.group(1));
        }
    ...
    public Object runFunction(String string, Object[] objectArray) {
        ...
        try {
            ...
            GlobalState.b("convertedParameters:");
            for (Object object2 : arrayList) {
                if (object2 == null) {
                    GlobalState.b("=null");
                    continue;
                }
                GlobalState.b("=" + object2.getClass().getName());
            }
            GlobalState.b("-----");
    ...
    public static void logError(String string) {
        GlobalState.e("ScriptEngine - error: " + string);
    }

    public static void logCritical(String string) {
        GlobalState.e("ScriptEngine - critical: " + string);
