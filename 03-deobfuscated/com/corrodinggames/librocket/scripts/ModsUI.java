...
import com.corrodinggames.librocket.scripts.ModsUI$1;
...
extends ScriptContext {
    ...
    Runnable updateModsRunnable = new ModsUI$1(this);
    int checkWorkshopSkip = 0;

    public ModsUI(MainUIController root) {
        this.root = root;
    }

    public SteamEngine getSteam() {
        SteamEngine a2 = SteamEngine.a();
        if (!a2.e()) {
            a2.h();
            return null;
        }
    ...
    public void setModFilter(String string) {
        ...
        if (elementDocument == null) {
            GlobalState.e("loadMods: No Active Document");
            return;
        }
    ...
    public void applyModFilter() {
        ...
        if (element2 == null) {
            GlobalState.e("loadMods: Failed to find modList, wrong page?");
            return;
        }
        ...
        int n2 = 0;
        int n3 = 0;
        for (Element element4_168 : (java.util.Collection<Element>) (java.util.Collection) arrayList) {
            boolean bl2 = false;
            String string2 = element4_168.getAttribute("data_sessionid");
            int n4 = com.corrodinggames.rts.gameFramework.GameUtils.parseInt(string2);
            ModInfo b2 = l2.bZ.a(n4);
            if (b2 == null) {
                GlobalState.e("Could not find mod with mod session id: " + n4);
            } else {
                if (string != null) {
                    boolean bl3 = false;
            ...
            if (bl2) {
                ++n2;
                element4_168.compareAndAddClass("modItemFilteredOut");
                continue;
            }
            ++n3;
            element4_168.removeClass("modItemFilteredOut");
        }
        Object object = "";
        if (n2 > 0 && n3 == 0) {
    ...
    public void refreshModList() {
        ElementDocument elementDocument = this.libRocket.getActiveDocument();
        if (elementDocument == null) {
            GlobalState.e("refreshModList: No Active Document");
            return;
        }
        GlobalState.e("refreshModList");
        Element element = elementDocument.getElementById("modTemplate");
        if (element == null) {
            GlobalState.e("refreshModList: Failed to find modTemplate, wrong page?");
            return;
        }
        GlobalState l2 = GlobalState.B();
        l2.bZ.d();
    ...
    public void loadMods() {
        ...
        GlobalState.e("loadMods");
        Element element = elementDocument.getElementById("modTemplate");
        Element element2 = elementDocument.getElementById("modList");
        if (element == null) {
            GlobalState.e("loadMods: Failed to find modTemplate, wrong page?");
            return;
        }
        if (element2 == null) {
            GlobalState.e("loadMods: Failed to find modList, wrong page?");
        ...
        String string2 = "";
        int n2 = 0;
        for (ModInfo b2 : (java.util.Collection<ModInfo>) (java.util.Collection) arrayList) {
            String string3;
            object = string;
            String string4 = b2.a();
            String string5 = "";
            object = ((String)object).replace("_NAME_", this.root.htmlString(string4));
            object = ((String)object).replace("_ID_", b2.modDescription);
            String string6 = b2.R;
            if (string6 == null) {
                string6 = "";
            } else {
            ...
            if (b2.modFileSize == 0L) {
                if (!b2.isCompatible && !b2.requiresUpdate) {
        ...
        for (ModInfo b2 : (java.util.Collection<ModInfo>) (java.util.Collection) arrayList) {
            object = elementDocument.getElementById(b2.modDescription);
            if (object == null) {
                GlobalState.b("Could not find:" + b2.c);
                continue;
            }
            ((Element)object).setCheckbox(!b2.isEnabled);
        }
        this.applyModFilter();
    }
    ...
    private void _rememberTempModSelection() {
        ...
        for (Element element : (java.util.Collection<Element>) (java.util.Collection) arrayList) {
            ...
            ModInfo b2 = l2.bZ.c(string);
            if (b2 == null) {
                GlobalState.a("Could not find mod:" + element.getInnerRML());
                continue;
            }
            boolean bl3 = bl2 = !element.getCheckbox();
            if (b2.isActiveMod != bl2) {
                bl = true;
            }
            b2.isActiveMod = bl2;
            b2.l = true;
    ...
    private void _restoreTempModSelection() {
        ...
        for (Element element : (java.util.Collection<Element>) (java.util.Collection) arrayList) {
            ...
            ModInfo b2 = l2.bZ.c(string);
            if (b2 == null) {
                GlobalState.a("Could not find mod:" + element.getInnerRML() + " id:" + string);
                continue;
            }
            if (!b2.l || b2.isActiveMod == (bl2 = !element.getCheckbox())) continue;
            bl = true;
            element.setCheckbox(!b2.isActiveMod);
        }
    }
    ...
    private void _saveModsCommon(boolean bl) {
        ...
        if (bl2) {
            GlobalState.e("mod changes made");
        } else {
            GlobalState.e("no mod changes made");
        }
        l2.bZ.e();
        l2.bQ.save();
        if (bl) {
    ...
    private void _saveModsMessages(boolean bl) {
        ...
        int n3 = l2.bZ.b();
        if (l2.bX.B) {
            GlobalState.e("savesMods: in network game");
            this.root.showAlert("You are currently in a network game, changes will be checked and applied on next game");
        } else if (com.corrodinggames.rts.game.units.custom.ModLoader.c(true)) {
            if (n2 == 0) {
    ...
    public void reloadModDataAsk() {
        GlobalState l2 = GlobalState.B();
        if (l2.I()) {
            GlobalState.e("Menu active, reloading without asking");
            this.reloadModData();
            return;
        }
