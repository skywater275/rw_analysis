...
public class TraitValueBuilder {
    int a;
    String b;
    boolean c;
    public float d;
    ...
    public float v = 0.3f;
    public float w;
    public Texture x;  // javap ba: m.e x (v19.133f6 修正, ParameterAnimator 为幻觉)
    public Texture[] y;  // javap ba: m.e[] y
    public boolean z;
    public float A;
    public Texture B;  // javap ba: m.e B
    public Texture[] C;  // javap ba: m.e[] C
    public Texture D;  // javap ba: m.e D
    public boolean E;
    ...
    public void a(TraitValueBuilder ba2) {
        this.d = ba2.d;
        this.e = ba2.e;
        this.i = ba2.i;
        this.j = ba2.j;
    ...
    public static void a(TraitValueBuilder ba2, ModUnitRegistry l2, ab ab2, String string, boolean bl2, ArrayList arrayList) {
        Float f2;
        Float f3;
        Boolean bl3;
        Boolean bl4;
        ...
        if ((n2 = ab2.b(string, "copyFrom", 0).intValue()) != 0) {
            ...
            object = (TraitValueBuilder)arrayList.get(n2 - 1);
            ba2.a((TraitValueBuilder)object);
        }
        ...
        Texture e7 = l2.a(ab2, string, "image_foot");
        if (e7 != null) {
            ba2.B = e7;
