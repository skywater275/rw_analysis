...
public strictfp class DirectionConfig {
    public boolean a;
    public float b;
    public int c;
    public int d;
    ...
    public static DirectionConfig a(ModUnitRegistry l2, ab ab2, String string, String string2, boolean bl) {
        DirectionConfig m2 = new DirectionConfig();
