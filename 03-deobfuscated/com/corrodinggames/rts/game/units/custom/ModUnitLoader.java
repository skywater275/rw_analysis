...
import com.corrodinggames.rts.game.units.custom.animation.k;
...
public class ModUnitLoader {
    ...
    public float t;
    public float u = 0.0f;
    public CustomActionBase v;  // 02b bn.java L37: custom.d.b v (d/b=CustomActionBase, v19.133f6 修正 KeyframePoint 幻觉)
    public int w = -1;
    public int x = -1;
    public ModUnitLoader y;
    public ModUnitLoader z;
    public boolean A;
    public boolean B = true;
    public LogicBoolean C;
    public bl D;
    public CustomVisuals E;
    public CustomVisuals F;
    public Integer G;
    public boolean H;
    public boolean I;
    ...
    public UnitConfig O;
    public UnitConfig P;  // 02 铁证: custom.bn.P:Lcustom/h;
    public float Q = 5.0f;
    public int R = 0;
    public int S = -1;
    ...
    public Float U;
    public float V = -1.0f;
    public float W = -1.0f;  // 02 铁证: custom.bn.java L64: float W = -1.0F (v19.133f6 删重复)
    public float X;
    public float Y;
    public float Z = 0.0f;
    public float aa;
    ...
    public Float aj;
    public UnitConfig ak;  // 02b bn.java L78: custom.h ak (TagFilter 为幻觉名, v19.133f6 修正)
    public float al = -1.0f;
    public float am = 2000.0f;
    public float an = -999.0f;
    public ModUnitLoader ao;
    public int ap = -1;
    ...
    public boolean ay;
    public int az;
    public AnimationReference aA;
    public float aB;
    public UnitActionDef aC;
    public com.corrodinggames.rts.gameFramework.rendering.Texture aD;  // 02b bn.java L97: m.e aD
    public com.corrodinggames.rts.gameFramework.rendering.Texture[] aE;  // 02b bn.java L98
    public com.corrodinggames.rts.gameFramework.rendering.Texture aF;  // 02b bn.java L99
    public float aG;
    public float aH;
    public int aI;
    public TagFilter aJ;
    ...
    public int a(CustomUnitType j2) {
    ...
    public void a(ModUnitLoader bn2) {
        this.f = bn2.f;
        this.g = bn2.g;
        this.h = bn2.h;
        this.j = bn2.j;
     ...
     * Lifted jumps to return sites
     */
    public static void a(ModUnitLoader bn2, ModUnitRegistry l2, ab ab2, String string) throws bo {
        Texture e2;
        Object object;
        Object object2;
        Float f2;
        ...
        if (string4 != null) {
            ...
            if (((ModUnitLoader)object3).c && !((ModUnitLoader)object3).d) {
                throw new RuntimeException("[" + string + "] Infinite loop detected with turret copies:" + string4);
            }
            if (!((ModUnitLoader)object3).d) {
                ModUnitLoader.a((ModUnitLoader)object3, l2, ab2, ((ModUnitLoader)object3).b);
            }
            bn2.a((ModUnitLoader)object3);
        } else {
            bn2.af = l2.ez;
            bn2.X = l2.ea;
        }
        ...
        CustomActionBase b2 = com.corrodinggames.rts.game.units.custom.resources.CustomActionBase.a(l2, ab2, string3, "resourceUsage", true);
        if (b2 != null && b2.d()) {
            bn2.v = b2;
            l2.a(b2);
        }
        ...
        bn2.ad = bn2.ab < 99999.0f ? bn2.ab : l2.cL.cooldownTime;
        ...
        if (bn2.aj != null) {
            l2.bE = true;
            l2.a(com.corrodinggames.rts.game.units.custom.animation.k.a);
        }
        bn2.ak = com.corrodinggames.rts.game.units.custom.TeamTag.deserializeTags(ab2.b(string3, "interceptProjectiles_withTags", (String)null), bn2.ak);
        if (bn2.ak != null) {
            l2.bF = true;
            l2.a(com.corrodinggames.rts.game.units.custom.animation.k.a);
        ...
        Texture e3 = l2.a(ab2, string3, "chargeEffectImage");
        if (e3 != null) {
            bn2.aF = e3;
            l2.fP = true;
        }
