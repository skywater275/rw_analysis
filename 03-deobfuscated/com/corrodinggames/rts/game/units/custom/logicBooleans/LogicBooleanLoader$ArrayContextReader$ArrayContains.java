...
extends LogicBooleanLoader$ArrayContextReader$ArrayFunction {
    ...
    public static final int indexOf(UnitType y2, LogicBoolean logicBoolean, LogicBoolean logicBoolean2) {
        block8: {
            ...
            UnitInstance am2 = logicBoolean2.readUnit(y2);
            if (VariableScope.isMarker(am2)) {
                ...
                for (int i = 0; i < n2; ++i) {
                    ...
                    UnitInstance am3 = logicBoolean5.readUnit(y2);
                    if (am3 == null || !GameUtils.j(f4, am3.eo) || !GameUtils.j(f5, am3.ep) || n3 != am3.player.k) continue;
                    return i;
                }
            } else {
                for (int i = 0; i < n2; ++i) {
                    LogicBoolean logicBoolean6 = logicBoolean.readArrayElement(y2, i);
                    UnitInstance am4 = logicBoolean6.readUnit(y2);
                    if (am2 != am4) continue;
                    return i;
                }
            }
