...
extends LogicString {
    ...
    public static String castToString(LogicBoolean$ReturnType logicBoolean$ReturnType, LogicBoolean logicBoolean, UnitType y2) {
        ...
        if (logicBoolean$ReturnType == LogicBoolean$ReturnType.unit) {
            return UnitInstance.A(logicBoolean.readUnit(y2));
        }
