...
extends VariableScope$CachedWriter$WriterFactory {
    ...
    public VariableScope$MemoryWriterFactory(ModUnitRegistry l2, VariableScope$VariableMapping variableMapping) {
        this.meta = l2;
        this.target = variableMapping;
    }

    public VariableScope$MemoryWriterFactory(ModUnitRegistry l2) {
        this.meta = l2;
        if (l2 != null) {
            this.target = l2.r;
        }
    ...
    @Override
    public VariableScope$CachedWriter$WriterElement createWriterElement(String string, String string2, String string3, String string4) throws bo {
        ...
        if (this.target != null) {
            ...
            variableScope$VariableName = variableScope$VariableDefinition.name;
            logicBoolean$ReturnType = variableScope$VariableDefinition.type;
        } else {
