...
extends LogicBooleanLoader$LogicBooleanScopeOnly {
    @Override
    public LogicBoolean parseNextElementInChain(String string, ModUnitRegistry l2, String string2, boolean bl2, String string3, String string4, LogicBoolean logicBoolean) {
