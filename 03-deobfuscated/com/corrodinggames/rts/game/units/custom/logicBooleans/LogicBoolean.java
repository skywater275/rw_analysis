...
implements Cloneable {
    ...
    static WeaponMount activeEvent;
    static UnitType outerUnitParameterContext;
    static final HashMap parameterMappings;

    public static final UnitType getParameterContext(UnitType y2) {
        UnitType y3 = outerUnitParameterContext;
        if (y3 != null) {
            return y3;
        }
        return y2;
    ...
    public static final void setOuterUnitParameterContext(UnitType y2) {
    ...
    public static void setContextEventSource(WeaponMount k2) {
        activeEvent = k2;
    }
    ...
    public LogicBoolean with(ModUnitRegistry l2, String string, String string2) {
    ...
    public static LogicBoolean create(ModUnitRegistry l2, String string) {
        return LogicBoolean.create(l2, string, null);
    }

    public static LogicBoolean create(ModUnitRegistry l2, String string, LogicBoolean logicBoolean) {
    ...
    public String valueToStringDebug(UnitType y2) {
        ...
        if (logicBoolean$ReturnType == LogicBoolean$ReturnType.unit) {
            return UnitInstance.A(this.readUnit(y2));
        }
    ...
    public abstract boolean read(UnitType var1);
    ...
    public abstract String getMatchFailReasonForPlayer(UnitType var1);
    ...
    public static String getAllParametersDebug(LogicBoolean logicBoolean, UnitType y2) {
        String string = "";
