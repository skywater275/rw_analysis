...
implements Cloneable {
    ...
    public final UnitInstance get(UnitInstance am2) {
        if (!(am2 instanceof UnitType)) {
            return null;
        }
        return this.getSingleRaw((UnitType)am2);
    }

    public final UnitInstance get(UnitType y2) {
        return this.getSingleRaw(y2);
    }

    public final UnitInstance getRealUnitOnly(UnitType y2) {
        UnitInstance am2 = this.getSingleRaw(y2);
    ...
    public abstract UnitInstance getSingleRaw(UnitType var1);
    ...
    public static UnitReference$UnitReferenceOrUnitType parseUnitTypeOrReferenceFromConf(ModUnitRegistry l2, ab ab2, String string, String string2, UnitReference$UnitReferenceOrUnitType unitReferenceOrUnitType) throws bo {
    ...
    public static UnitReference$UnitReferenceOrUnitType parseUnitTypeOrReference(ModUnitRegistry l2, String string, String string2, String string3, UnitReference$UnitReferenceOrUnitType unitReference$UnitReferenceOrUnitType) throws bo {
        if (string == null) {
        ...
        ActionBinding v2 = l2.a(string, string3, string2);
        if (v2 != null) {
            v2.f = true;
        }
    ...
    public static UnitReference parseUnitReferenceFromConf(ModUnitRegistry l2, ab ab2, String string, String string2, UnitReference unitReference) throws bo {
        String string3 = ab2.b(string, string2, (String)null);
        return UnitReference.parseUnitReference(l2, string3, string, string2, unitReference, false);
    }

    public static UnitReference parseUnitReference(ModUnitRegistry l2, String string, String string2, String string3, UnitReference unitReference, boolean bl) throws bo {
        if (string == null) {
    ...
    public static UnitReference parseSingleUnitReferenceElement(ModUnitRegistry l2, String string) {
    ...
    public static UnitReference parseSingleUnitReferenceBlock(ModUnitRegistry l2, String string) {
        int n2 = al.b(string);
        if (n2 != 0) {
            if (n2 > 0) {
    ...
    @Override
    public UnitReference with(ModUnitRegistry l2, String string, String string2) {
    ...
    public String getMatchFailReasonForPlayer(UnitType y2) {
        return this.getClassDebugName() + "(" + UnitInstance.A(this.getSingleRaw(y2)) + ")";
    }
