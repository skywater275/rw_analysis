...
implements LogicBooleanLoader$LogicBooleanContext {
    ...
    public static LogicBoolean defaultParseNextElementInChain(LogicBooleanLoader$LogicBooleanContext logicBooleanLoader$LogicBooleanContext, String string, ModUnitRegistry l2, String string2, boolean bl, String string3, String string4, LogicBoolean logicBoolean, HashMap hashMap) {
        ...
        if (hashMap != null && hashMap.size() < 8 && hashMap.size() > 0) {
            ...
            boolean bl2 = true;
            for (String string9 : (java.util.Collection<String>) (java.util.Collection) hashMap.keySet()) {
                if (!bl2) {
                    string8 = string8 + ", ";
                }
                bl2 = false;
