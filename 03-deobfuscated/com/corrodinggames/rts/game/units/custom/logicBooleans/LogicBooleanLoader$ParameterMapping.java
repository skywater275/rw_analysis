...
public class LogicBooleanLoader$ParameterMapping {
    public HashMap<String, LogicBooleanLoader$ParameterMapping$FieldOrMethod> parameters = new HashMap();
    ...
    public LogicBooleanLoader$ParameterMapping(Class clazz) {
        ...
        Iterator methodArray = arrayList.iterator();  // 02b L27: Iterator var3 = var2.iterator() 铁证
        while (methodArray.hasNext()) {
            Field methodArray2 = (Field)methodArray.next();  // 02b L30: Field var4 = (Field)var3.next() 铁证
            ...
            this.addParameter(string, new LogicBooleanLoader$ParameterMapping$FieldOrMethod(methodArray2), parameter);
        }
