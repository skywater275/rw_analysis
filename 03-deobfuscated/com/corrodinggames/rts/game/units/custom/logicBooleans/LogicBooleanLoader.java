...
public class LogicBooleanLoader {
    ...
    public static LogicBoolean parseNumberBlock(ModUnitRegistry l2, String string) {
     ...
     */
    public static LogicBoolean parseBooleanBlock(ModUnitRegistry l2, String string, boolean bl) {
        Object object;
        Object object2;
        int n2;
        Object object3;
        ...
        for (String string3 : stringArray2) {
            Object object4;
            Object object42 = string3;
            if (!GameUtils.c(string2, string3)) continue;
            boolean bl2 = false;
            boolean bl3 = false;
            ...
            if (logicBoolean$ReturnType && (logicBoolean$JoinerBoolean instanceof CompareJoinerBoolean$CompareNotEqualBoolean || logicBoolean$JoinerBoolean instanceof CompareJoinerBoolean$CompareEqualBoolean)) {
                com.corrodinggames.rts.gameFramework.GlobalState.e(logicBoolean$JoinerBoolean.type() + " was set to require boolean. Workaround triggered. requireBooleanChildren:" + logicBoolean$JoinerBoolean.requireBooleanChildren());
        ...
        if (string.length() > 0) {
            ...
            if (GameUtils.isLenientNumeric((String)(object = al.c((String)object)))) {
                if (bl) {
            ...
            String string5 = GameUtils.unescapeQuotedString(string);
            if (string5 != null) {
                if (bl) {
        ...
        for (int i = 0; i < stringArray3.length; ++i) {
            String string7;
            if (object6 != null) {
                string7 = (String)object6;
                object6 = null;
            } else {
                string7 = stringArray3[i];
            }
            if (GameUtils.b(string7, '[') && (n2 = al.b(string7, "[", 0)) != -1) {
                if (n2 == 0) {
            ...
            if ((object2 = ((LogicBooleanLoader$LogicBooleanContext)object3).parseNextElementInChain(string11, l2, string7, bl5, string, string6, (LogicBoolean)object5)) == null) {
    ...
    public static void setArgumentsWithMapping(LogicBooleanLoader$ParameterMapping logicBooleanLoader$ParameterMapping, Object object, String string, ModUnitRegistry l2, String string2) {
        if (string2 == null) {
    ...
    public static Object getArgumentTextWithMapping(LogicBooleanLoader$ParameterMapping$FieldOrMethod logicBooleanLoader$ParameterMapping$FieldOrMethod, Object object) {
        ...
        if (logicBooleanLoader$ParameterMapping$FieldOrMethod != null && logicBooleanLoader$ParameterMapping$FieldOrMethod.method != null) {
            com.corrodinggames.rts.gameFramework.GlobalState.e("getArgumentTextWithMapping: method not supported");
            return "<method>";
        }
        com.corrodinggames.rts.gameFramework.GlobalState.e("getArgumentTextWithMapping: No method or field");
        return "<error>";
    }

    public static void setArgumentWithMapping(LogicBooleanLoader$ParameterMapping logicBooleanLoader$ParameterMapping, Object object, String string, String string2, ModUnitRegistry l2) {
    ...
    public static Object convertParameterData(String string, Class clazz, ModUnitRegistry l2, LogicBoolean$ReturnType logicBoolean$ReturnType, String string2) {
        if (string == null) {
            return null;
        }
        ...
        if (GameUtils.isStrictDecimal(string)) {
        ...
        if (matcher != null) {
            return GameUtils.stripBackslashes(matcher.group(1));
        }
