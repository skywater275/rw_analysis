...
extends LogicBoolean {
    ...
    public static String arrayToString(UnitType y2, LogicBoolean logicBoolean) {
    ...
    public static String arraySummaryToString(UnitType y2, LogicBoolean logicBoolean) {
        int n = logicBoolean.getArraySize(y2);
