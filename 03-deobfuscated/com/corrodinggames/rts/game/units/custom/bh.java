...
public class bh
extends com.corrodinggames.rts.game.GameSettings {
    public String bh;
    public int bi;
    public ModUnitRegistry bj;

    public static void a(bh bh2, ModUnitRegistry l2, ab ab2, String string) throws bo {
        Object object;
        Object object2;
        String[] object3Arr;
        TagFilter object3;
        ...
        if (object4 != null) {
            bh2.B = (Texture) object4;
        }
        if ((e3 = l2.a(ab2, string4, "shadowImage")) != null) {
            bh2.C = e3;
        }
        bh2.ad = ab2.a(string4, "beamImageOffsetRate", Float.valueOf(bh2.ad)).floatValue();
        com.corrodinggames.rts.gameFramework.rendering.Texture e4 = l2.a(ab2, string4, "beamImage");
        if (e4 != null) {
            bh2.Y = e4;
            bh2.X = true;
            if (e4.q < 20 && !com.corrodinggames.rts.gameFramework.GlobalState.aU()) {
        ...
        Texture e5 = l2.a(ab2, string4, "beamImageEnd");
        if (e5 != null) {
            bh2.ab = e5;
            if (e4 == null) {
        ...
        if (string5 != null) {
            if (string5.equalsIgnoreCase("true")) {
                ...
                bh2.af = false;
                bh2.ah = l2.a(string5, (CustomVisuals) null);
            }
        }
        if ((string3 = ab2.b(string4, "effectOnCreate", (String)null)) != null) {
            bh2.ai = l2.a(string3, (CustomVisuals) null);
        }
        ...
        bh2.aD = ab2.a(l2, string4, "retargetingInFlightSearchOnlyTags", (UnitConfig) null);
        if (bh2.ax > 1500.0f) {
        ...
        if (string6 != null) {
            bh2.aX = l2.a(string6, (CustomVisuals) null);
        }
        if ((string2 = ab2.b(string4, "explodeEffectOnShield", (String)null)) != null) {
            bh2.aY = l2.a(string2, (CustomVisuals) null);
        }
        ...
        bh2.bd = com.corrodinggames.rts.game.units.custom.TeamTag.deserializeTags(ab2.b(string4, "tags", (String)null));
        CustomArrayList m2 = ab2.k(string, "mutator");
        CustomArrayList m3 = new CustomArrayList();
        for (Iterator iterator = m2.iterator(); iterator.hasNext(); ) {
            String string7 = (String) iterator.next();
            object3Arr = string7.split("_");
            if (object3Arr.length <= 1 || m3.contains(object2 = (String)(object = object3Arr[0]) + "_") || ((String)object).length() <= "mutator".length()) continue;
            m3.add(object2);
        }
        for (String string7 : (java.util.Collection<String>) (java.util.Collection) m3) {
            String string8;
            object3 = new TagFilter();
            object3.tagName = com.corrodinggames.rts.game.units.custom.TeamTag.deserializeTags(ab2.b(string4, string7 + "ifUnitWithTags", (String)null));
            object3.tagValue = com.corrodinggames.rts.game.units.custom.TeamTag.deserializeTags(ab2.b(string4, string7 + "ifUnitWithoutTags", (String)null));
            if (object3.tagName == null && object3.tagValue == null) {
                throw new RuntimeException("[" + string4 + "]" + string7 + " requires: unitWithTags and/or unitWithoutTags");
            }
            object3.matchType = ab2.a(string4, string7 + "directDamageMultiplier", Float.valueOf(1.0f)).floatValue();
            object3.inclusiveFilter = ab2.a(string4, string7 + "areaDamageMultiplier", Float.valueOf(1.0f)).floatValue();
            object = ResourceComponent.a(l2, ab2, string, string7 + "addResourcesDirectHit", true);
            if (object != null && ((com.corrodinggames.rts.game.units.custom.resources.CustomActionBase) object).d()) {
                object3.excludeFilter = (com.corrodinggames.rts.game.units.custom.resources.CustomActionBase) object;
                if (bh2.s) {
                    throw new RuntimeException("[" + string4 + "]" + string7 + "addResourcesDirectHit doesn't work with targetGround, UnitTypeHandle it will never get direct hits (use addResourcesAreaHit)");
                }
            }
            if ((object2 = ResourceComponent.a(l2, ab2, string, string7 + "addResourcesAreaHit", true)) != null && ((com.corrodinggames.rts.game.units.custom.resources.CustomActionBase) object2).d()) {
                object3.fallback = (com.corrodinggames.rts.game.units.custom.resources.CustomActionBase) object2;
                if (n4 == null) {
            ...
            if ((string8 = ab2.b(string4, string7 + "changedExplodeEffect", (String)null)) != null) {
                object3.isActive = l2.a(string8, (CustomVisuals) null);
                if (object3.isActive != null && !object3.isActive.a()) {
                    object3.isActive = null;
                }
            }
            boolean bl2 = false;
            boolean bl3 = false;
            if (!GameUtils.cosFast(object3.matchType, 1.0f)) {
                bl2 = true;
            }
            if (!GameUtils.cosFast(object3.inclusiveFilter, 1.0f) && bh2.c != 0 && bh2.i > 0) {
                bl3 = true;
            }
            if (object3.excludeFilter != null) {
                bl2 = true;
            }
            if (object3.fallback != null) {
                bl3 = true;
            }
            if (bl2) {
                if (bh2.be == null) {
                    bh2.be = new CustomArrayList();
                }
                bh2.be.add(object3);
            }
            if (bl3) {
                if (bh2.bf == null) {
                    bh2.bf = new CustomArrayList();
                }
                bh2.e = true;
                bh2.bf.add(object3);
            }
            if (object3.isActive == null) continue;
            if (bh2.bg == null) {
                bh2.bg = new CustomArrayList();
            }
            bh2.bg.add(object3);
        }
        if (bh2.c != 0 && bh2.i > 0) {
    ...
    public static void a(bh bh2, com.corrodinggames.rts.gameFramework.network.OutputNetStream as2) {
        as2.a(bh2.bj);
        as2.c(bh2.bh);
    }

    public static com.corrodinggames.rts.game.GameSettings b(InputNetStream k2) {
        com.corrodinggames.rts.game.units.UnitTypeHandle as2 = k2.q();
        String string = k2.readString();
        if (as2 == null) {
            return null;
        }
        if (!(as2 instanceof ModUnitRegistry)) {
            com.corrodinggames.rts.gameFramework.GlobalState.b("ProjectileTemplate:readInLinkCustom: Got non CustomUnitMetadata object of:" + as2.i() + " loading real_meta");
            return null;
        }
        ModUnitRegistry l2 = (ModUnitRegistry) as2;
        bh bh2 = l2.f(string);
        if (bh2 == null) {
            com.corrodinggames.rts.gameFramework.GlobalState.b("ProjectileTemplate:readInLinkCustom: Could not find projectile with name:" + string);
            return null;
        }
        return bh2;
    }

    public void a(UnitInstance am2, com.corrodinggames.rts.game.MovementController f2, UnitInstance am3, float f3, float f4, float f5) {  // 02b bh.a(j,f,...) 参数2=game.f
        bh bh2 = this;
        if (am3 == null) {
            f2.aC = true;
            f2.n = f3;
            f2.o = f4;
            if (bh2.aK != 0.0f) {
                f2.n += (float)GameUtils.a((com.corrodinggames.rts.gameFramework.GameObject) am2, (int)(-bh2.aK * 100.0f), (int)(bh2.aK * 100.0f), 2) / 100.0f;
                am2.bC = (int)((float)am2.bC + f2.n);
                f2.o += (float)GameUtils.a((com.corrodinggames.rts.gameFramework.GameObject) am2, (int)(-bh2.aK * 100.0f), (int)(bh2.aK * 100.0f), 3) / 100.0f;
            ...
            if (bh2.aK != 0.0f) {
                f2.n += (float)GameUtils.a((com.corrodinggames.rts.gameFramework.GameObject) am2, (int)(-bh2.aK * 100.0f), (int)(bh2.aK * 100.0f), 2) / 100.0f;
                f2.o += (float)GameUtils.a((com.corrodinggames.rts.gameFramework.GameObject) am2, (int)(-bh2.aK * 100.0f), (int)(bh2.aK * 100.0f), 7) / 100.0f;
            }
        } else {
            f2.l = am3;
        }
