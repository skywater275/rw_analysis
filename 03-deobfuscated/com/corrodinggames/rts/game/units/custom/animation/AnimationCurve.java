...
public strictfp class AnimationCurve
extends AnimationCurveBase {
    static Paint a = new Paint();
    static UniquePaint b = new UniquePaint();
    CustomArrayList c = new CustomArrayList();
    CustomArrayList d = new CustomArrayList();
    CustomArrayList e = new CustomArrayList();
    CustomArrayList f = new CustomArrayList();
    CustomArrayList g = new CustomArrayList();
    boolean h;
    static final PointF i = new PointF();
    static AnimationVisibilityCurve j = new AnimationVisibilityCurve("");
    static final Rect k = new Rect();
    static final RectF l = new RectF();

    private static AnimationResourceCurve c(ModUnitRegistry l2, String string) {
        for (AnimationResourceCurve d2 : (java.util.Collection<AnimationResourceCurve>) (java.util.Collection) l2.q) {
    ...
    public static AnimationVisibilityCurve a(ModUnitRegistry l2, String string) {
        ...
        AnimationVisibilityCurve g2 = new AnimationVisibilityCurve(string);
        l2.a(g2);
        return g2;
    }
     ...
     */
    /* 02b custom/b/c.java 对应方法: 大量抛 checked bo (R8 移除 throws) */
    public static void a(ModUnitRegistry l2, ab ab2) throws bo {
        AnimationCurve c2 = null;
        String string = "decal_";
        CustomArrayList m2 = ab2.e(string);
        for (Iterator iterator2 = m2.iterator(); iterator2.hasNext(); ) {  // 02b custom/b/c.java L80-83: (String)var5.next()
            ...
            AnimationResourceCurve d2 = new AnimationResourceCurve();
            d2.a = string4;
            if (string4.contains(",")) {
            ...
            d2.G = (AnimationActivationCurve) ab2.a(string2, "layer", AnimationActivationCurve.d, AnimationActivationCurve.class);
            ...
            if (n3 >= 2) {
                throw new bo("[" + string2 + "]Doesn'ModifierApplier make sense to set more than one onlyWhenSelectedBy* to true at AnimationCurveBase time.");
            }
            d2.b = n3 > 0;
            d2.g = ab2.a(string2, "includeParentsSelection", (Boolean)false);
            d2.h = (UnitTypeComparator)ab2.a(string2, "onlyTeam", UnitTypeComparator.any, UnitTypeComparator.class);  // 02b custom/b/c.java L134: (q)var1.a(...,q.f,q.class) (q=UnitTypeComparator)
            ...
            boolean bl3 = false;
            if (d2.G == AnimationActivationCurve.e) {
                bl3 = true;
            }
            ...
            if ((logicBoolean = ab2.c(l2, string2, "imageScale", null)) != null) {
                if (LogicBoolean.isStaticNumber(logicBoolean)) {
                    d2.filterRadiusMultiplier = LogicBoolean.getKnownStaticNumber(logicBoolean);
                } else {
                    d2.q = true;
                    d2.r = logicBoolean;
                }
            ...
            Texture e2 = l2.a(ab2, string2, "image");
            if (e2 != null) {
                e e5 = new e();  // 02b custom/b/c.java L218: e var18 (e=02b custom/b/e)
                e5.a = e2;
                if (e5.a != null && bl4) {
                    e5.frameTextures = l2.a(e2, l2.ac);  // 02b L221: var18.b = var0.a(var17, var0.ac)
                }
                e5.a(d2);
                d2.v = e5;
                d2.u = true;
            ...
            if ((object4 = ab2.b(string2, "imageStack", (String)null)) != null && !((String)object4).equals("")) {
                ...
                String[] stringArraySplit = ((String)object4).split(",");  // 02b L235: String[] var20 = var36.split(",")
                for (String string5 : stringArraySplit) {
                    Object object2;
                    ...
                    e e6 = new e();  // 02b custom/b/c.java L294: e var46 (e=02b custom/b/e)
                    e6.a = l2.a(l2.F, string8, l2.ab, string2, "imageStack");  // 02b L295
                    if (e6.a == null) {
                        throw new bo("[" + string2 + "]failed to load image " + string8);
                    }
                    if (bl2) {
                        e6.frameTextures = l2.a(e6.a, l2.ac);  // 02b L301
                    }
                    e6.a(d2);  // 02b L304
                    for (int i = 0; i < n5; ++i) {
                        ((ArrayList)serializable).add(e6);
                    }
                }
                if (((ArrayList)serializable).size() > 0) {
                    d2.w = (e[])((ArrayList)serializable).toArray(new e[0]);  // 02b L312  // 02b L312: (e[])var19.toArray(new e[0])
                }
            }
            ...
            String stringArray = null;  // 02b custom/b/c.java L354: var21 (String)
            if (object3 != null || stringArray != null) {
                String stringArray3;  // 02b L355: var39 (String)
                if (object3 != null && stringArray != null) {
                ...
                if (stringArray != null) {
                    ...
                    stringArray3 = (String)object3;
                }
                d2.ae = l2.b(stringArray3);
                if (d2.ae == -1) {
                    throw new bo("[" + string2 + "]basePositionFromLeg* failed to find: " + stringArray3);
                }
            }
            if ((string3 = ab2.b(string2, "basePositionFromTurret", (String)null)) != null) {
                ModUnitLoader bn2 = l2.e(string3);
                if (bn2 == null) {
            ...
            d2.P = ab2.a(string2, "color", Integer.valueOf(-1));
            ...
            if (d2.P != -1 || d2.Q != 1.0f || f2 != 1.0f) {
                int n6;
                d2.ah = new UniquePaint();
                d2.ah.b(d2.P);
                if (d2.P != -1) {
                    com.corrodinggames.rts.gameFramework.rendering.FontRenderer.a(d2.ah);
                }
            ...
            if (!bl2) continue;
            if (c2 == null) {
                c2 = new AnimationCurve();
                l2.getUnitNameWithoutModPrefix(c2);
            }
            if (!d2.b) {
                c2.h = true;
            }
            if (d2.C != null && d2.G != AnimationActivationCurve.a) {
                c2.c.add(d2);
            }
            if ((object = d2.G == AnimationActivationCurve.c ? c2.f : (d2.G == AnimationActivationCurve.b ? c2.e : (d2.G == AnimationActivationCurve.e ? c2.g : (d2.G == AnimationActivationCurve.a ? c2.c : (d2.G == com.corrodinggames.rts.game.units.custom.animation.AnimationActivationCurve.f ? null : c2.d))))) == null) continue;
            ((CustomArrayList) object).add(d2);
            Collections.sort(((CustomArrayList) object));
        }
    }
    ...
    @Override
    public void d(CustomUnitType j2, float f2) {
        this.a(j2, f2, AnimationActivationCurve.a, this.c);
        this.a(j2, f2, AnimationActivationCurve.b, this.e);
    }

    @Override
    public void e(CustomUnitType j2, float f2) {
        this.a(j2, f2, AnimationActivationCurve.c, this.f);
    }

    @Override
    public void c(CustomUnitType j2, float f2) {
        this.a(j2, f2, AnimationActivationCurve.d, this.d);
    }

    @Override
    public void f(CustomUnitType j2, float f2) {
        this.a(j2, f2, AnimationActivationCurve.e, this.g);
    }

    public static Rect a(AnimationResourceCurve d2, e e2, Texture e3, int n2) {
        int n3 = e2.frameWidth;
        int n4 = e2.frameHeight;
        int n5 = 0;
        int n6 = 0;
        if (n2 > 0) {
            int n7;
    ...
    public static RectF a(AnimationResourceCurve d2, e e2, Texture e3, float f2, float f3) {
        int n2 = e2.frameWidth;
        int n3 = e2.frameHeight;
        RectF rectF = l;
    ...
    public final void a(CustomUnitType j2, float f2, AnimationActivationCurve f3, CustomArrayList m2) {
        AnimationCurve.a(j2, f2, f3, m2, null);
    }

    public static final void a(CustomUnitType j2, float f2, AnimationActivationCurve f3, CustomArrayList m2, PointF pointF) {
        Object object;
        int n2 = m2.a;
        if (n2 == 0) {
            return;
        ...
        boolean bl2 = j2.cG;
        boolean bl3 = false;
        UnitInstance am2 = j2.dr();
        if (am2 != null) {
            if (am2.cG) {
                bl3 = true;
            }
            if ((object = am2.getActiveBuildOrTarget()) != null && ((UnitInstance) object).cG) {
                bl3 = true;
            }
        }
        object = com.corrodinggames.rts.gameFramework.GlobalState.B();
        float f4 = ((GlobalState)object).cX;
        boolean bl4 = f3 == AnimationActivationCurve.a;
        ...
        for (int i2 = 0; i2 < n2; ++i2) {
            ...
            Object object2;
            Object object3;
            AnimationResourceCurve d2 = (AnimationResourceCurve) objectArray[i2];
            if (d2.b && !bl2 && !bl3 || d2.j > f4 || d2.k && !j2.bT() || d2.l && j2.isDead) continue;
            if (d2.b) {
                boolean bl5 = bl2;
                if (d2.g && bl3) {
                    bl5 = true;
                ...
                if (!bl5) continue;
                PlayerState n3 = ((GlobalState)object).bs;  // 02b custom/b/c.java L601: n var16 (n=PlayerState)
                PlayerState n4 = j2.player;  // 02b L602: n var17 = var0.bX
                if (n3 != null && (d2.c && n4 != n3 || d2.d && !n4.c(((GlobalState)object).bs) || d2.e && (!n4.d(((GlobalState)object).bs) || n4 == n3))) continue;
            }
            if (d2.F != null && !d2.F.read(j2) || d2.o >= 0 && j2.a != d2.o || d2.i && !((GlobalState)object).bS.m(j2) || d2.h != UnitTypeComparator.any && d2.h != null && ((GlobalState)object).bs != null && !((GlobalState)object).bs.a(d2.h, j2.player) || d2.m && !j2.cp || d2.n && j2.cp) continue;
            if (d2.ae != -1) {
                i[] iArray2 = j2.dT;  // 02b L622: i[] var20 = var0.dT
                TraitValueBuilder[] baArray = j2.x.ax;  // 02b L623: ba[] var21 = var0.x.ax
                if (iArray2 == null || iArray2.length <= d2.ae || baArray == null || baArray.length <= d2.ae) continue;
                i i3 = iArray2[d2.ae];
                TraitValueBuilder ba2 = baArray[d2.ae];
                f15 = j2.eo + i3.b;
                f14 = j2.ep + i3.frictionValue;
                f13 = j2.eq + i3.accelerationValue;
                f12 = i3.airSpeedMultiplier + i3.arrivalDistance + ba2.R + 90.0f;
                f11 = i3.airSpeedMultiplier + i3.arrivalDistance + ba2.R;
                if (d2.af) {
                    float f16 = j2.cg;
                    if (j2.x.dE) {
                        f16 = j2.cL[j2.x.dG].turretAngle;
                    }
                    f10 = GameUtils.cosFast(f16);
                    f9 = GameUtils.sinFast(f16);
                    f8 = f10 * ba2.k - f9 * ba2.j;
                    f7 = f9 * ba2.k + f10 * ba2.j;
                    f6 = GameUtils.d(i3.b, i3.frictionValue, f8, f7);
                    f5 = com.corrodinggames.rts.gameFramework.GameUtils.a(i3.b, i3.frictionValue, f8, f7);
                    f12 = f6 + 90.0f;
                    f11 = f6 + 90.0f;
                }
            } else if (d2.ag != -1) {
                ...
                int n5 = d2.ag;
                com.corrodinggames.rts.gameFramework.utility.ai ai2 = j2.F(n5);  // 02b L656: ai var45 = var0.F(var43)
                f15 = ai2.a;
                f14 = ai2.b;
                f13 = j2.eq + ai2.c;
                f12 = j2.cL[n5].turretAngle + 90.0f;
                f11 = j2.cL[n5].turretAngle;
            } else {
                if (d2.ac == null) {
                    object3 = j2;
                } else {
                ...
                f15 = ((UnitInstance)object3).eo;  // 02b L673: ((am)var44).eo
                f14 = ((UnitInstance)object3).ep;
                f13 = ((UnitInstance)object3).eq;
                if (pointF != null && d2.ac == null) {
                    f15 = pointF.a;
                    f14 = pointF.b;
                    f12 = 0.0f;
                }
                f12 = ((UnitInstance)object3).cg + 90.0f;  // 02b L682: ((am)var44).cg
                f11 = ((UnitInstance)object3).cg;
                if (d2.ac == null && j2.x.dC) {
                    float f17 = j2.cL[j2.x.dG].turretAngle;
                    f12 = f17 + 90.0f;
                    f11 = f17;
                }
            }
            ...
            if (d2.R != 0.0f || d2.S != 0.0f) {
                float f18 = GameUtils.cosFast(f11);
                float f19 = GameUtils.sinFast(f11);
                float f20 = d2.R;
                float f21 = d2.S;
                f15 += f18 * f21 - f19 * f20;
                f14 += f19 * f21 + f18 * f20;
            ...
            f13 += d2.V;
            if (bl4 && d2.C != null) {
                TextureManagerInterface y2 = ((GlobalState)object).bO;
                float f22 = f15 - ((GlobalState)object).cw + d2.D;
                float f23 = f14 - ((GlobalState)object).cx + d2.E;
                float f24 = f12;
                Paint paint = j2.R();
                Texture e2 = d2.C;
                y2.k();
                y2.a(f24, f22, f23);
                y2.clearScreen(e2, f22, f23, paint);
                y2.l();
                return;
            }
            if (d2.u) {
                TextureManagerInterface y3 = ((GlobalState)object).bO;
                float f25 = f15 - ((GlobalState)object).cw;
                float f26 = f14 - ((GlobalState)object).cx - f13;
                float f27 = f12;
                Paint paint = d2.ah;
                if (paint == null) {
                    paint = j2.aN();
                ...
                if (d2.v != null) {
                    e e3 = d2.v;
                    Texture e4 = e3.frameTextures != null ? e3.frameTextures[j2.player.getTeamIndex()] : e3.a;  // 02b b/e: b=frameTextures
                    y3.k();
                    y3.a(f27, f25, f26);
                    f7 = d2.filterRadiusMultiplier;
                    f6 = d2.filterRadiusMultiplier;
                    if (d2.q) {
                        if (d2.r != null) {
                    ...
                    if (!d2.I) {
                        y3.clearScreen(e4, f25, f26, paint);
                    } else {
                        Rect rect = AnimationCurve.a(d2, e3, e4, n7);
                        RectF rectF = AnimationCurve.a(d2, e3, e4, f25, f26);
                        y3.loadImageFromResource(e4, rect, rectF, paint);
                    }
                    y3.l();
                }
                if (d2.w != null) {
                    f9 = d2.filterRadiusMultiplier;
                    f8 = d2.filterRadiusMultiplier;
                    if (d2.q) {
                        if (d2.r != null) {
                    ...
                    for (int i4 = n8; i4 < n9; ++i4) {
                        ...
                        e e5 = eArray[n11];
                        Texture e6 = e5.frameTextures != null ? e5.frameTextures[j2.player.getTeamIndex()] : e5.a;  // 02b b/e: b=frameTextures
                        ...
                        int n12 = n7 + n11 * d2.y;
                        Rect rect = AnimationCurve.a(d2, e5, e6, n12);
                        RectF rectF = AnimationCurve.a(d2, e5, e6, f25, f26 - f28);
                        y3.loadImageFromResource(e6, rect, rectF, paint);
                        y3.l();
                    }
                }
            }
            ...
            if (object3 == null) continue;
            float f29 = f15 - ((GlobalState)object).cw;
            float f30 = f14 - ((GlobalState)object).cx - f13;
            float f31 = ((UnitInstance)object3).eo - ((GlobalState)object).cw;
            float f32 = ((UnitInstance)object3).ep - ((GlobalState)object).cx - ((UnitInstance)object3).eq;
            Paint paint = d2.ah;
            if (paint == null) {
                paint = b;
            }
            ...
            ((GlobalState)object).bO.a(f29, f30, f31, f32, paint);
        }
    }

    static /* synthetic */ AnimationResourceCurve b(ModUnitRegistry l2, String string) {
        return AnimationCurve.c(l2, string);  // 02b 合成方法: c.c (类自身)
    }
}