...
import com.corrodinggames.rts.gameFramework.opengl.aa;
import com.corrodinggames.rts.gameFramework.opengl.GLObject;
import com.corrodinggames.rts.gameFramework.opengl.SpriteShader;
...
public class DrawBatch {
    ...
    int d;
    int e;
    GLRenderer f;  // 02b b/y.java: n f
    int g;
    SpriteShader h;  // 02b b/y.java: d h
    ShaderLayout i;  // 02b b/y.java: final z i
    public ShaderLayout j;
    GLObject k;  // 02b b/y.java: b k
    Shader l;
    boolean m;
    int n;
    float o;
    ...
    void a(GLObject b2) {
        ...
        com.corrodinggames.rts.gameFramework.opengl.GLRenderer.q();
        GLES20.glUniform1i((int)this.j.e.uniformName, (int)0);
        com.corrodinggames.rts.gameFramework.opengl.GLRenderer.q();
        this.k = b2;
    }
    ...
    public void a(GLObject b2, RectF rectF, RectF rectF2, float[] fArray) {
        if (this.e == this.d) {
            this.c();
        }
        this.a(b2);
