...
import com.corrodinggames.rts.gameFramework.opengl.batch.resources.GLResourceBase;
...
public class b {
    ...
    float p;
    boolean q = true;
    private com.corrodinggames.rts.gameFramework.opengl.batch.resources.GLTexture x;
    private int y;
    private int z;
    public Paint r;
    ...
    public b(com.corrodinggames.rts.gameFramework.opengl.batch.resources.GLTexture b2, AssetManager assetManager) {
        if (b2 == null) {
            b2 = new GLResourceBase();
            b2.a();
        }
        this.a = assetManager;
