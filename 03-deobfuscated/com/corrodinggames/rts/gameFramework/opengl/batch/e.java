...
public class e {
    ...
    public void c() {
        ...
        if (this.a == 0) {
            ...
            this.a = nArray[0];
            if (this.a == 0) {
                com.corrodinggames.rts.gameFramework.opengl.batch.b.b("Failed to gen texture page");
                return;
            }
        }
    ...
    public c a(char c2, Paint paint) {
        ...
        f2 = (int)f2;
        if (f2 > (float)this.j) {
            com.corrodinggames.rts.gameFramework.opengl.batch.b.b("Warning chr is larger then cellWidth: " + c2);
        }
        float f3 = n3 + this.m;
