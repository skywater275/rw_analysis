...
import com.corrodinggames.rts.gameFramework.network.SteamInputStream;
import com.corrodinggames.rts.gameFramework.network.SteamOutputStream;
...
extends Socket {
    ...
    public void a(NetworkPacket au2) {
        this.a.a(new PacketHandler(this.b, au2));
    }

    public SteamSocket(PacketDecoder c2, int n) {
        this.a = c2;
        this.b = n;
        this.d = new SteamInputStream(this);
        this.e = new SteamOutputStream(this);
    }
    ...
    public synchronized void close() {
        if (!this.c) {
            this.c = true;
            GlobalState.e("Closing steam socket");
        }
        if (this.d != null) {
            this.d.a(new byte[0]);
        }
