...
public class al {
        ...
        for (int i = 0; i < n4; ++i) {
            ...
            if (n6 != 0) {
                ...
                if (cArray[n2] == c4) {
                    ...
                    GlobalState.e("Bad bracket order: '" + string + "' at index:" + i + " got " + c4 + " type expected: " + cArray[n2]);
                }
            }
            if (n2 == 0) {
                n5 = 0;
    ...
    public static String[] b(String string, String string2, boolean bl) {
        ...
        return (String[]) al.a(string, string2, bl).toArray(new String[0]);
    }

    public static int a(String string, int n2) {
        char c2 = string.charAt(n2);
        if (c2 != '(') {
            GlobalState.b("getBracketEnd: Did not start on a bracket");
            return -1;
        }
        ...
        for (int i = n2; i < string.length(); ++i) {
            ...
            if (n6 != 0) {
                ...
                if (cArray[n3] == c4) {
                    ...
                    GlobalState.e("Bad bracket order: '" + string + "' at index:" + i + " got " + c4 + " type expected: " + cArray[n3]);
                }
            }
