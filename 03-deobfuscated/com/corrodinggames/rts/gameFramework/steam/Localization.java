...
import com.corrodinggames.rts.gameFramework.steam.MultiResourceBundle;
...
public final class Localization {
    ...
    static strictfp PropertyResourceBundle a(String string) {
        AssetStream j2 = com.corrodinggames.rts.gameFramework.filesystem.FileLoader.k("translations/" + string);
        if (j2 == null) {
            return null;
        }
    ...
    static strictfp ResourceBundle a(String string, Locale locale) {
        String string2 = Localization.a(string, Locale.ROOT, false, false) + ".properties";
        PropertyResourceBundle propertyResourceBundle = Localization.a(string2);
        if (propertyResourceBundle == null) {
            throw new RuntimeException("Root locate file:" + string2 + " is missing, it is required");
        }
        boolean bl = Locale.ROOT.equals(locale);
        if (bl) {
            GlobalState.e("Locale: Using " + string2 + " as locale");
            return propertyResourceBundle;
        }
        String string3 = Localization.a(string, locale, true, true) + ".properties";
        PropertyResourceBundle propertyResourceBundle2 = Localization.a(string3);
        if (propertyResourceBundle2 == null) {
            GlobalState.e("Locale: No locale for " + string3 + " checking locale without variant ");
            string3 = Localization.a(string, locale, true, false) + ".properties";
            propertyResourceBundle2 = Localization.a(string3);
            if (propertyResourceBundle2 == null) {
                GlobalState.e("Locale: No locale for " + string3 + " checking locale without variant or country");
                string3 = Localization.a(string, locale, false, false) + ".properties";
                propertyResourceBundle2 = Localization.a(string3);
                if (propertyResourceBundle2 == null) {
                    GlobalState.e("Locale: No locale for " + string3 + " using base locale");
                    return propertyResourceBundle;
                }
            }
        }
        GlobalState.e("Locale: Using " + string3 + " as locale");
        return new MultiResourceBundle(propertyResourceBundle2, propertyResourceBundle);
    }
    ...
    public static strictfp String c() {
        ...
        return Localization.d().getLanguage();
    }
    ...
    public static synchronized strictfp void e() {
        ...
        if (a != null && b == bl) {
            GlobalState.e("Locale.reload: skipping reload");
        }
        if (Build.VERSION.SDK_INT >= 9) {
            ResourceBundle.clearCache();
        }
        if (bl) {
            GlobalState.e("Locale: forceEnglish");
            a = Localization.a("Strings", Locale.ROOT);
        } else if (d != null) {
            a = Localization.a("Strings", new Locale(d));
        } else if (settingsEngine != null && settingsEngine.overrideLanguageCode != null && !settingsEngine.overrideLanguageCode.equals("")) {
            a = Localization.a("Strings", new Locale(settingsEngine.overrideLanguageCode));
        } else {
            Locale locale = Locale.getDefault();
            GlobalState.e("Locale: default targetLocale:" + locale);
            if (locale != null) {
                GlobalState.e("Locale: default targetLocale ISO3:" + locale.getISO3Language());
            }
            a = Localization.a("Strings", locale);
        }
        b = bl;
        boolean bl2 = false;
        if (bl2) {
    ...
    private static final strictfp String d(String string) {
        String string2;
        try {
            ResourceBundle resourceBundle = Localization.b();
            string2 = resourceBundle.getString(string);
        }
        catch (NullPointerException nullPointerException) {
            String string3 = "NullPointer with key:" + string + " locale:" + Localization.b().getLocale().toString();
    ...
    private static final strictfp boolean e(String string) {
        try {
            Localization.b().getString(string);
            return true;
        }
    ...
    public static final strictfp String a(String string, String string2, Object ... objectArray) {
        try {
            return Localization.a(string, objectArray);
        }
        catch (MissingResourceException missingResourceException) {
            return string2;
        }
    ...
    public static final strictfp String a(String string, Object ... objectArray) {
        String string2 = Localization.d(string);
    ...
    public static final strictfp String b(String string) {
        ...
        if (Localization.e(string4)) {
            String string5 = Localization.a(string4, new Object[0]);
            if (string3 != null) {
                string5 = string5 + string3;
            }
            GlobalState.e("translated:" + string5);
            if (string5 != null) {
    ...
    public static strictfp String c(String string) {
        ...
        while (matcher.find()) {
            if (++n2 > 100) {
                GlobalState.b("convertInlineBlocks: Too many loops while parsing: " + string);
                return string;
            }
            String string2 = matcher.group(1);
            String string3 = Localization.a(string2, null, new Object[0]);
            if (string3 == null) {
                GlobalState.e("convertInlineBlocks: No key:" + string2);
