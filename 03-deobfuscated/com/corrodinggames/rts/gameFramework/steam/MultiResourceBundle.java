...
strictfp class MultiResourceBundle
extends ResourceBundle {
    ResourceBundle a;
    ResourceBundle b;

    public MultiResourceBundle(ResourceBundle resourceBundle, ResourceBundle resourceBundle2) {
        this.a = resourceBundle;
        this.b = resourceBundle2;
    }

    public Enumeration getKeys() {
        GlobalState.e("MultipleResourceBundle: Slow get keys");
