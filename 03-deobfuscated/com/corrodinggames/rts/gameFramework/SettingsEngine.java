...
public class SettingsEngine {
    ...
    public boolean saveToFileSystem() {
        ...
        GlobalState.e("Saving settings to: " + file.getAbsolutePath());
        try {
            String string;
            ...
            for (Object object : l2.bT.allBindings) {
                if (!((KeyBinding) object).isActive || ((KeyBinding) object).d()) continue;
                string = "";
                string = string + ((KeyBinding) object).e();
                String string2 = l2.bT.digitToKeycode((KeyBinding) object);
            ...
            GlobalState.B().a("Failed to save preferences, IO error", 1);
            return false;
        }
        return true;
    }
    ...
    public void loadFromFileSystem() {
        ...
        if (!file.exists()) {
            GlobalState.e("preferences not found, not loading (" + string + ")");
            return;
        }
        GlobalState.e("loadFromFileSystem filepath: " + file.getAbsolutePath());
        String string2 = "settings";
        try {
            String string3;
            String string4;
            ab ab2 = new ab(string);
            Iterator iterator2 = this.settingFields.entrySet().iterator();
            while (iterator2.hasNext()) {
                Map.Entry object = (Map.Entry) iterator2.next();
                string4 = (String)object.getKey();
                string3 = ab2.b(string2, string4, (String)null);
                if (l.aZ) {
                    GlobalState.e(string4 + "= " + string3);
                }
                if (string3 == null || "".equals(string3)) continue;
                if (string4.startsWith("key.")) {
                    string4 = string4.replace("key.", "");
                    GlobalState.e("loading keybind:" + string4);
                    l2.bT.digitToKeycode(string4, string3);
                    continue;
                }
                this.setValueDynamic(string4, string3);
            }
            Iterator iterator3 = l2.bT.allBindings.iterator();
            while (iterator3.hasNext()) {
                KeyBinding ad2 = (KeyBinding) iterator3.next();
                if (!ad2.isActive || ad2.d() || (string3 = ab2.b("keys", string4 = ad2.e(), (String)null)) == null || "".equals(string3)) continue;
                l2.bT.digitToKeycode(string4, string3);
            }
        }
        catch (IOException iOException) {
            iOException.printStackTrace();
            GlobalState.B().a("Failed to load preferences, IO error", 1);
        }
    }
    ...
    private SettingsEngine(Context context) {
        ...
        for (Field field : fieldArray = this.getClass().getFields()) {
            ...
            if (this.settingFields.get(string) != null) {
                GlobalState.e("SettingsEngine: fields: " + string + " already exists");
            }
            if (l.aZ) {
                GlobalState.e("SettingsEngine: field:" + string);
            }
        ...
        this.mouseSupport = this.getBooleanPref("mouseSupport", !GlobalState.d(context));
        ...
        boolean bl9 = false;
        if (GlobalState.at() && AndroidUIHelper.b(AndroidUIHelper.a())) {
            bl9 = true;
        }
        int n4 = 0;
        if (bl9) {
    ...
    public boolean loadMainExternalFolder(boolean bl) {
        ...
        GlobalState.e("loadMainExternalFolder..");
        GlobalState l2 = GlobalState.B();
        if (bl && l2.c()) {
            GlobalState.e("Not loading due to extra safe mode");
            return false;
        }
        ...
        if (string == null) {
            GlobalState.e("No external folder set");
            return false;
        }
        GlobalState.e("External saf link: " + string);
        GlobalState.e("External saf shown path: " + string2);
        GlobalState.e("External saf extra: " + string3);
        try {
            Uri uri = Uri.parse((String)string);
            boolean bl2 = false;
            String string4 = null;
            String string5 = com.corrodinggames.rts.gameFramework.utility.filesystem.a.a(uri, true);
            GlobalState.e("safVirualPathBase: " + string5);
            if (string5 == null) {
                GlobalState.e("createSAFLink failed for uri: " + uri);
                bl2 = true;
            } else {
                string4 = string5 + string3;
                GlobalState.e("safVirualPath: " + string4);
                if (!com.corrodinggames.rts.gameFramework.filesystem.FileLoader.isEnabled3(string4)) {
                    GlobalState.e("isDirectory failed for: " + string4);
                    bl2 = true;
                }
            }
            if (bl2) {
                GlobalState.e("error for uri: " + uri);
                ...
                if (com.corrodinggames.rts.gameFramework.mods.VersionChecker.currentVersion == null) {
                    com.corrodinggames.rts.gameFramework.mods.VersionChecker.currentVersion = "";
                }
                com.corrodinggames.rts.gameFramework.mods.VersionChecker.currentVersion = com.corrodinggames.rts.gameFramework.mods.VersionChecker.currentVersion + string6;
                com.corrodinggames.rts.gameFramework.mods.VersionChecker.latestVersion = string6;
                return false;
            }
            GlobalState.e("Using external path");
            l2.bQ.externalSAFWorking = true;
            com.corrodinggames.rts.gameFramework.filesystem.FileLoader.d = string4;
            return true;
        }
