...
public final class HUDElement {
    private final HUDManager ay;
    public ay a = com.corrodinggames.rts.game.units.custom.ay.defaultEffectTemplate;
    public com.corrodinggames.rts.gameFramework.GameObject b;  // 02b d/e.java L25: w b (EffectConfig 为幻觉名)
    public boolean c;
    public boolean d;
    ...
    public boolean o;
    public boolean p;
    public DrawLayer q = DrawLayer.a;
    public boolean r;
    public boolean s;
    public float t;
    public boolean u;
    ...
    public UniquePaint at = HUDElement.a();
    public float au;
    public int av;
    public boolean aw;
    public static UniquePaint[] ax = new UniquePaint[128];

    protected HUDElement(HUDManager c2) {
        this.ay = c2;
    }

    public void c() {  // 02b d/e.java L157: c() 重置方法 (reset2 为幻觉名)
    ...
    public static UniquePaint a() {
        return com.corrodinggames.rts.gameFramework.utility.PathfindingUtils.b();
    }



    public UniquePaint a(float f) {
    ...
    public void b(float f2) {
        ...
        this.V -= f2;
        if (this.b != null && !this.a.liveAfterAttachedDies) {
            this.V = -1.0f;
        }
        if (this.V < 0.0f) {
            this.b();
        ...
        if (this.v) {
            if (this.K > 0.0f) {
                ...
                if (this.R < 0.0f) {
                    this.R = -this.R;
                    this.R *= 0.5f;
                    this.R = com.corrodinggames.rts.gameFramework.GameUtils.a(this.R, 1.3f);
                }
                if (this.K < 0.0f) {
                    this.K = 0.0f;
                }
                ...
                this.P = com.corrodinggames.rts.gameFramework.GameUtils.a(this.P, 0.15f * f2);
                this.Q = com.corrodinggames.rts.gameFramework.GameUtils.a(this.Q, 0.15f * f2);
                this.Z = com.corrodinggames.rts.gameFramework.GameUtils.a(this.Z, 1.0f * f2);
            }
        }
        this.I += this.P * f2;
        this.J += this.Q * f2;
    ...
    public static void a(int n2, HUDElementRenderer g2, Rect rect) {
        int n3 = 0;
        if (n2 >= g2.h) {
            n3 += n2 / g2.h;
            n2 %= g2.h;
    ...
    public boolean a(GlobalState l2, boolean bl2) {
        UniquePaint ag2;
        LightingColorFilter lightingColorFilter;
        float f2;
        int n2;
        float f3;
        Rect rect = com.corrodinggames.rts.gameFramework.effects.HUDManager.o;
        RectF rectF = com.corrodinggames.rts.gameFramework.effects.HUDManager.n;
        if (this.U > 0.0f) {
            return false;
        }
        if (bl2 && this.K < 1.0f) {
        ...
        HUDElementRenderer g2 = this.a.imageStrip != null ? this.a.imageStrip : com.corrodinggames.rts.gameFramework.effects.HUDManager.s[this.aq];
        if (!g2.k) {
            int n3 = this.ap;
            HUDElement.a(n3, g2, rect);
        } else {
            rect.a(0, 0, g2.i.m(), g2.i.l());
        }
        PointF pointF = !bl2 ? com.corrodinggames.rts.gameFramework.GameUtils.d(this.I, this.J, this.K) : com.corrodinggames.rts.gameFramework.GameUtils.d(this.I, this.J, 0.0f);
        boolean bl3 = this.ar == 4;
        float f4 = 1.0f;
        if (this.G != 1.0f || this.F != 1.0f || this.H) {
            boolean bl4;
            f4 = com.corrodinggames.rts.gameFramework.GameUtils.f(this.G, this.F, 1.0f - this.V / this.W);
        ...
        if (!(bl3 && !this.L || com.corrodinggames.rts.gameFramework.GameUtils.a(l2.cN, rectF))) {
            return false;
        }
        ...
        if (this.S != 0.0f) {
            float f6 = com.corrodinggames.rts.gameFramework.GameUtils.sinFast((this.W - this.V) / this.T * 360.0f) * this.S;
            rectF.a(0.0f, f6);
        }
        ...
        if (bl6 && com.corrodinggames.rts.gameFramework.GlobalState.at() && !bl2 && this.B == null) {
            int n6 = com.corrodinggames.rts.gameFramework.GameUtils.b(255, (int)(f8 * 255.0f), (int)(f9 * 255.0f), (int)(f10 * 255.0f));
            if (C != null && D == n6) {
                this.B = C;
            } else {
        ...
        if (this.ar == 3) {
            if (com.corrodinggames.rts.gameFramework.effects.HUDManager.k == null) {
                com.corrodinggames.rts.gameFramework.GlobalState.e("Loading displacement shader");
                try {
                    com.corrodinggames.rts.gameFramework.effects.HUDManager.k = new Shader("assets/shaders/post_displacement.frag");
                }
            ...
            if (this.ay.l != null) {
                Shader ae2 = com.corrodinggames.rts.gameFramework.effects.HUDManager.k;
        ...
        if (!bl6) {
            ...
            ag2 = this.at;
            int n7 = com.corrodinggames.rts.gameFramework.GameUtils.b(255, (int)(f8 * 255.0f), (int)(f9 * 255.0f), (int)(f10 * 255.0f));
            f2 = this.au - f3;
            if (f2 < -0.01f || f2 > 0.01f || this.av != n7) {
                this.au = f3;
                this.av = n7;
                int n8 = com.corrodinggames.rts.gameFramework.GameUtils.b((int)(f3 * 255.0f), (int)(f8 * 255.0f), (int)(f9 * 255.0f), (int)(f10 * 255.0f));
                this.at.b(n8);
            }
        }
        if (this.aa != null) {
        ...
        if (this.L) {
            pointF = com.corrodinggames.rts.gameFramework.GameUtils.d(this.M, this.N, this.O);
            y2.a(rectF.a, rectF.b, pointF.a - l2.cw, pointF.b - l2.cx, this.ay.w);
        } else if (bl2) {
            if (g2.j != null) {
                y2.loadImageFromResource(g2.j, rect, rectF, (Paint)ag2);
            }
        } else {
            y2.loadImageFromResource(g2.i, rect, rectF, (Paint)ag2);
        }
        if (n2 != 0) {
            y2.l();
        }
