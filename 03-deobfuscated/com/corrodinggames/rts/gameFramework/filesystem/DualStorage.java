...
public class DualStorage
extends StorageBackend {
    StorageBackend g;  // 02b: 双存储后端 1 (PlatformBackend 为误标)
    StorageBackend h;  // 02b: 双存储后端 2
    String i;
    String j;

    public DualStorage(StorageBackend c2, String string, StorageBackend c3, String string2) {
        this.g = c2;
        this.i = string;
        this.h = c3;
        this.j = string2;
    ...
    public boolean a(String string, boolean bl) {
        StorageBackend c2 = this.r(string);
    ...
    private StorageBackend r(String string) {
        if (string == null) {
            return null;
        }
    ...
    private StorageBackend s(String string) {
        StorageBackend c2 = this.r(string);
        if (c2 != null) {
            return c2;
        }
