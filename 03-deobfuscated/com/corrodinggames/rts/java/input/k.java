...
import com.corrodinggames.rts.java.input.l;
import com.corrodinggames.rts.java.input.m;
...
extends Socket {
    ...
    public k(SteamManager b2, SteamID steamID) {
        this.a = b2;
        this.e = steamID;
        this.c = new l(this);
        this.d = new m(this);
    ...
    public synchronized void close() throws IOException {
        if (!this.b) {
            this.b = true;
            com.corrodinggames.rts.gameFramework.GlobalState.e("Closing steam socket");
        }
        if (this.c != null) {
            this.c.a(new byte[0]);
        }
