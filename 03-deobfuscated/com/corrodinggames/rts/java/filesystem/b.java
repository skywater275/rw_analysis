...
import com.corrodinggames.rts.java.filesystem.a;
...
extends ElementWrapper {
    ...
    public boolean a() {
        ...
        if (af2 != null) {
            ...
            if (inputStream == null) {
                GlobalState.isKeyJustPressed("Failed to open zipped file: " + this.a);
                return false;
            }
        } else {
            try {
        ...
        try {
            ...
            this.h = com.corrodinggames.rts.java.Slick2DRenderer.r.C();
            this.i = true;
        }
        catch (IOException iOException) {
            GlobalState.a("Exception loading image: " + this.a, (Throwable)iOException);
            this.h = com.corrodinggames.rts.java.Slick2DRenderer.s.C();
            this.i = true;
        }
        catch (UnsupportedOperationException unsupportedOperationException) {
            unsupportedOperationException.printStackTrace();
            GlobalState.a("Exception loading image: " + this.a, (Throwable)unsupportedOperationException);
            this.h = com.corrodinggames.rts.java.Slick2DRenderer.s.C();
            this.i = true;
        }
        ...
        if (this.c && (this.width > 500 || this.height > 500)) {
            GlobalState.e("Map thumbnail is too large. Size:(" + this.width + "," + this.height + ") (max:500 pixels)");
            this.h = com.corrodinggames.rts.java.Slick2DRenderer.t.C();
            this.i = true;
            this.width = this.h.getWidth();
            this.height = this.h.getHeight();
        }
