...
import com.corrodinggames.rts.java.audio.backend.f;
...
implements Iterable {
    ...
    private int l;
    private int m;
    private f n;  // 02b a/e.java L22: private f n (迭代器缓存, SoundEffect 幻觉)
    private f o;  // 02b L23
    ...
    public e(int n, float f2) {
        ...
        if ((n = com.corrodinggames.rts.java.audio.backend.m.b((int)Math.ceil((float)n / f2))) > 0x40000000) {  // 02b a/e.java L34: m.b(int) (全限定防字段 m 遮蔽 F7)
    ...
    public Object a(int n, Object object) {
        int n2 = this.d;  // 02b a/e.java L88: var10 = this.d
        if (n == 0) {
    ...
    private void a(int n, Object object, int n2, int n3, int n4, int n5, int n6, int n7) {
        ...
        int n11 = this.m;
        while (true) {
            switch (com.corrodinggames.rts.java.audio.backend.m.a(2)) {  // 02b a/e.java L184 (全限定防字段 m 遮蔽 F7)
                case 0: {
                    n8 = n3;
    ...
    public boolean equals(Object object) {
        ...
        e e2 = (e)object;  // 自身类型 (AudioManager 幻觉)
        if (e2.a != this.a) {
            return false;
        }
        if (e2.g != this.g) {
