...
import com.corrodinggames.rts.java.audio.backend.AudioListener;
...
import com.corrodinggames.rts.java.audio.backend.d;
...
import com.corrodinggames.rts.java.audio.backend.o;
...
implements Audio {
    ...
    private d idleSources;  // 02b backend/d (v19.133f4 AudioDecoder 幻觉修正)
    private d allSources;
    private AudioManager soundIdToSource;  // 02b backend/i (v19.133f4 修正)
    private e sourceToSoundId;  // 02b backend/e (v19.133f4 修正)
    private long nextSoundId = 0L;
    private o extensionToSoundClass = new o();  // 02b backend/o (v19.133f4 AudioCapture 幻觉修正)
    ...
    public OpenALAudio(int n, int n2, int n3) {
        ...
        this.registerSound("ogg", Ogg$Sound.class);  // 03 顶级类 (v19.133f4 修正)  // 02b Ogg$Sound (v19.133f4 修正)
        this.registerMusic("ogg", Ogg$Music.class);  // 03 顶级类 (v19.133f4 修正)  // 02b Ogg$Music (v19.133f4 修正)
        this.registerSound("wav", Wav$Sound.class);  // 03 顶级类 (v19.133f4 修正)  // 02b Wav$Sound (v19.133f4 修正)
        this.registerMusic("wav", Wav$Music.class);  // 03 顶级类 (v19.133f4 修正)  // 02b Wav$Music (v19.133f4 修正)
        try {
            AL.create();
        }
        ...
        this.soundIdToSource = new AudioManager();
        this.sourceToSoundId = new e();  // 02b L96: new e() (v19.133f4 修正)
    ...
    @Override
    public OpenALSound newSound(AudioSourceBase a2) {
        if (a2 == null) {
        ...
        try {
            return (OpenALSound)clazz.getConstructor(OpenALAudio.class, AudioSourceBase.class).newInstance(this, a2);  // 02b a/a (v19.133f4 修正)
        }
    ...
    @Override
    public OpenALMusic newMusic(AudioSourceBase a2) {
        if (a2 == null) {
            throw new IllegalArgumentException("file cannot be null.");
        }
        ...
        try {
            return (OpenALMusic)clazz.getConstructor(OpenALAudio.class, AudioSourceBase.class).newInstance(this, a2);  // 02b a/a (v19.133f4 修正)
        }
        catch (Exception exception) {
    ...
    public void setSoundPan(long l, float f2, float f3) {
        ...
        int n = (Integer)this.soundIdToSource.a(l);
        AL10.alSource3f((int)n, (int)4100, (float)m.b((f2 - 1.0f) * (float)Math.PI / 2.0f), (float)0.0f, (float)m.a((f2 + 1.0f) * (float)Math.PI / 2.0f));  // 02b m.a/m.b sin/cos (v19.133f4 修正)
