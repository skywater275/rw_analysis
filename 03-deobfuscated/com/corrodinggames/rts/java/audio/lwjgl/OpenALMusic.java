...
import com.corrodinggames.rts.java.audio.backend.AudioClip;
...
implements Music {
    ...
    private AudioClip renderedSecondsQueue = new AudioClip(3);
    ...
    protected final AudioSourceBase file;
    protected int bufferOverhead = 0;
    private Music$OnCompletionListener onCompletionListener;

    public OpenALMusic(OpenALAudio openALAudio, AudioSourceBase a2) {
