...
extends SteamInterface {
    ...
    public int getHTTPResponseHeaderSize(SteamHTTPRequestHandle steamHTTPRequestHandle, String string)  throws SteamException {
        return SteamHTTP.getHTTPResponseHeaderSize(this.pointer, steamHTTPRequestHandle.handle, string);
    }

    public boolean getHTTPResponseHeaderValue(SteamHTTPRequestHandle steamHTTPRequestHandle, String string, ByteBuffer byteBuffer) throws SteamException {
    ...
    public int getHTTPResponseBodySize(SteamHTTPRequestHandle steamHTTPRequestHandle)  throws SteamException {
    ...
    public boolean getHTTPStreamingResponseBodyData(SteamHTTPRequestHandle steamHTTPRequestHandle, int n, ByteBuffer byteBuffer) throws SteamException {
        if (!byteBuffer.isDirect()) {
            throw new SteamException("Direct buffer required!");
        }
