...
public enum SteamFriends$FriendFlags {
    ...
    private SteamFriends$FriendFlags(int var3_1) {
    ...
    static int asBits(Collection collection) {
        int n = 0;
        for (SteamFriends$FriendFlags steamFriends$FriendFlags : (Collection<SteamFriends$FriendFlags>) (Collection) collection) {
