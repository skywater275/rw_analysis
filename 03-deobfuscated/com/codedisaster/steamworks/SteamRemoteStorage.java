...
extends SteamInterface {
    ...
    public boolean fileWrite(String string, ByteBuffer byteBuffer, int n)  throws SteamException {
    ...
    public boolean fileRead(String string, ByteBuffer byteBuffer, int n)  throws SteamException {
        if (!byteBuffer.isDirect()) {
            throw new SteamException("Direct buffer required!");
        }
    ...
    public SteamAPICall fileWriteAsync(String string, ByteBuffer byteBuffer)  throws SteamException {
        if (!byteBuffer.isDirect()) {
            throw new SteamException("Direct buffer required!");
        }
