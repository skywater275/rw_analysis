...
extends SteamInterface {
    ...
    public void sendUserDisconnect(SteamID steamID)  throws SteamException {
        SteamGameServer.sendUserDisconnect(this.pointer, steamID.handle);
    }

    public boolean updateUserData(SteamID steamID, String string, int n)  throws SteamException {
        return SteamGameServer.updateUserData(this.pointer, steamID.handle, string, n);
    }

    public SteamAuthTicket getAuthSessionTicket(Buffer buffer, int[] nArray) throws SteamException {
        if (!buffer.isDirect()) {
