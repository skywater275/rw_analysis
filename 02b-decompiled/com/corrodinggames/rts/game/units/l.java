...
class l extends com.corrodinggames.rts.game.units.a.x {
   ...
   public strictfp l(boolean var1, boolean var2) {
   ...
   public strictfp boolean b(am var1) {
      h var2 = h.L();
      return var2 != null?var2.G == n.b:true;
   }

   public strictfp String b() {
      if(this.b) {
         h var1 = h.L();
         return var1 != null?(var1.F != null?var1.F.a():"All types"):"Type Filter";
      } else {
   ...
   public strictfp String d() {
      if(!this.b) {
         ...
         h var1 = h.L();
         return var1 == null?"NA":(var1.F == null?"All mods":var1.F.a());
      }
   }
