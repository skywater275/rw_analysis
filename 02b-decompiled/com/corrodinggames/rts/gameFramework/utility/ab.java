...
public class ab {
   ...
   public ab(InputStream var1, String var2) {
      this.a = var2;
      this.a(var1);
   }
      ...
      try {
         ...
         while((var3 = var1.readLine()) != null) {
            ...
            if(var5 || !var9.startsWith("#")) {
               if(com.corrodinggames.rts.gameFramework.f.c(var3, "\"\"\"")) {
                  int var11 = 0;
               ...
               if(var9.length() != 0) {
                  ...
                  if(var4 == null || !var4.startsWith("comment_")) {
                     ...
                     if(var18.matches()) {
                        if(var4 == null) {
                           com.corrodinggames.rts.gameFramework.l.b("IniFile: " + this.a + "  line " + var2 + " is not in a [section]:\'" + var3 + "\'");
                        ...
                        if(var18.find()) {
                           ...
                           com.corrodinggames.rts.gameFramework.l.b(this.a + ": Unexpected format on line:" + var2 + ": \'" + var3 + "\' in ini file");
                           this.e.add(var3);
                        }
                     }
                  }
   ...
   public com.corrodinggames.rts.game.units.custom.aj a(com.corrodinggames.rts.game.units.custom.l var1, String var2, String var3, String var4) {
      bb var5 = this.a(var2, var3, var4, true);
      if(var5 == null) {
         return null;
      } else {
         try {
   ...
   public bb a(String var1, String var2, String var3, boolean var4) {
      String var5;
      if(var4) {
      ...
      if(var5 != null && var5.startsWith("i:")) {
         ...
         var6.e = var6.e.trim();
         com.corrodinggames.rts.gameFramework.h.a.a(var6.e, new Object[0]);
         return var6;
      } else {
   ...
   public LogicBoolean a(com.corrodinggames.rts.game.units.custom.l var1, String var2, String var3) {
   ...
   public LogicBoolean a(com.corrodinggames.rts.game.units.custom.l var1, String var2, String var3, LogicBoolean var4) {
   ...
   public LogicBoolean b(com.corrodinggames.rts.game.units.custom.l var1, String var2, String var3, LogicBoolean var4) {
      return this.a(var1, var2, var3, var4, LogicBoolean$ReturnType.unit);
   }

   public LogicBoolean c(com.corrodinggames.rts.game.units.custom.l var1, String var2, String var3, LogicBoolean var4) {
      return this.a(var1, var2, var3, var4, LogicBoolean$ReturnType.number);
   }

   public LogicBoolean a(com.corrodinggames.rts.game.units.custom.l var1, String var2, String var3, LogicBoolean var4, LogicBoolean$ReturnType var5) {
      String var6 = this.b(var2, var3, (String)null);
      return a(var6, var1, var2, var3, var4, var5);
   }

   public static LogicBoolean a(String var0, com.corrodinggames.rts.game.units.custom.l var1, String var2, String var3, LogicBoolean var4) {
      return a(var0, var1, var2, var3, var4, LogicBoolean$ReturnType.unit);
   }

   public static LogicBoolean a(String var0, com.corrodinggames.rts.game.units.custom.l var1, String var2, String var3, LogicBoolean var4, LogicBoolean$ReturnType var5) {
      try {
         if(var0 == null) {
            return var4;
         } else if(var5 == LogicBoolean$ReturnType.number && com.corrodinggames.rts.gameFramework.f.r(var0)) {
   ...
   public com.corrodinggames.rts.game.units.custom.g a(String var1, String var2, com.corrodinggames.rts.game.units.custom.g var3) {
      String var4 = this.b(var1, var2, (String)null);
      if(var4 == null) {
         return var3;
         ...
         return com.corrodinggames.rts.game.units.custom.g.c(var4);
      }
   }

   public com.corrodinggames.rts.game.units.custom.h a(com.corrodinggames.rts.game.units.custom.l var1, String var2, String var3, com.corrodinggames.rts.game.units.custom.h var4) {
      String var5 = this.b(var2, var3, (String)null);
      return com.corrodinggames.rts.game.units.custom.g.a(var5, var4);
   }

   public com.corrodinggames.rts.game.units.custom.u a(com.corrodinggames.rts.game.units.custom.l var1, String var2, String var3, com.corrodinggames.rts.game.units.custom.u var4) {
      String var5 = this.b(var2, var3, (String)null);
      if(var5 == null) {
         return var4;
      } else {
         com.corrodinggames.rts.game.units.custom.u var6 = var1.c(var5, var3, var2);
         return var6;
      }
   }

   public com.corrodinggames.rts.game.units.custom.e.a a(com.corrodinggames.rts.game.units.custom.l var1, String var2, String var3, com.corrodinggames.rts.game.units.custom.e.a var4, boolean var5) {
      String var6 = this.b(var2, var3, (String)null);
      if(var6 == null) {
         return var4;
      } else {
         com.corrodinggames.rts.game.units.custom.e.a var7;
         if(var5) {
            var7 = com.corrodinggames.rts.game.units.custom.e.a.a(var6);
            if(var7 != null) {
               return var7;
            }
         }
   ...
   public Integer a(String var1, String var2, Integer var3) {
      ...
      if(var4 == null) {
         ...
         try {
            return Integer.valueOf(Color.a(var4));
   ...
   public static Enum a(String var0, Enum var1, Class var2) {
      if(var0 == null) {
         return var1;
      } else {
         var0 = var0.trim();
   ...
   private static RuntimeException a(String var0, Class var1) {
      ...
      throw new bo("Unknown value: " + var0 + " (Expected: " + com.corrodinggames.rts.gameFramework.f.b(var2, (int)100) + ")");
   }

   public m c(String var1) {
      m var2 = new m();
   ...
   public m k(String var1, String var2) {
      m var3 = new m();
      Map var4 = (Map)this.j.get(var1);
      if(var4 != null) {
         Iterator var5 = var4.keySet().iterator();
   ...
   public m f(String var1, String var2, String var3) {
      m var4 = new m();
   ...
   public m m(String var1, String var2) {
      m var3 = new m();
   ...
   public static com.corrodinggames.rts.game.units.custom.g j(String var0, String var1, String var2) {
      var2 = var2.trim();
      if(var2.contains(",")) {
         ...
         com.corrodinggames.rts.game.units.custom.g var3 = com.corrodinggames.rts.game.units.custom.g.c(var2);
         return var3;
      }
   }
