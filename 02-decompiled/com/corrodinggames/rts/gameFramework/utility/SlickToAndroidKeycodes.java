...
public class SlickToAndroidKeycodes {
    ...
    public static HashMap a(String string, HashMap hashMap, HashMap hashMap2) {
        ...
        if (arrayList.size() != 0) {
            ...
            l.e(string + ": Could not find keycode for: " + (String)object);
        }
        return hashMap3;
    }
    ...
    static {
        d = SlickToAndroidKeycodes.a(SlickCodes.class);
        e = SlickToAndroidKeycodes.a(AndroidCodes.class);
        f = SlickToAndroidKeycodes.a(GdxCodes.class);
