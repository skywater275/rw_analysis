    ...
    public void a(Context context) {
        ...
        if (this.c) {
            ...
            for (SAFInterface.FileRow fileRow : arrayList) {
                ...
                Uri uri = com.corrodinggames.rts.gameFramework.utility.a.a.a.getChildUri(this.b, string);
                String string2 = fileRow.name;
                boolean bl = fileRow.isDirectory;
                if (string2.contains("/")) {
                    com.corrodinggames.rts.gameFramework.utility.a.a.h("Name contains symbols: " + string2);
