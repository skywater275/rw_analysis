...
extends af {
    ...
    public static ah d(String string, boolean bl) {
        ...
        synchronized (hashMap) {
            ...
            if (ah2 == null) {
                String string3 = bl ? string2 : com.corrodinggames.rts.gameFramework.e.a.e(string2);
                try {
                    ...
                    String string5 = "";
                    if (com.corrodinggames.rts.gameFramework.e.a.g(string2)) {
                        ag.h("isDirectory: " + string2);
                        string4 = "Failed to open .rwmod file (Appears to be a directory!). Please remove .rwmod from any folder names.";
                    }
                    com.corrodinggames.rts.gameFramework.e.a.b(string4 + string5);
                    return null;
                }
