...
extends BasicGame {
    ...
    public void a() {
        ...
        if (bl != this.v) {
            com.corrodinggames.rts.gameFramework.l.e("Grabbing mouse:" + bl);
            this.v = bl;
            if (!this.u) {
    ...
    public void a(int n2, int n3, boolean bl) {
        if (this.y) {
            com.corrodinggames.rts.gameFramework.l.e("mouseGrab:m:" + bl + ",newX:" + n2 + ",newY:" + n3);
        }
        if (!this.v) {
    ...
    public void g() {
        ...
        try {
            ...
            if (bl) {
                ...
                if (!string.equals("native")) {
                    ...
                    if (stringArray.length != 2) {
                        com.corrodinggames.rts.gameFramework.l.b("Unknown resolution format:" + string);
                    } else {
                        ...
                        if (n5 == null || n6 == null) {
                            com.corrodinggames.rts.gameFramework.l.b("Bad resolution int:" + string);
                        } else {
                            n3 = n5;
                            n4 = n6;
                        }
            ...
            if (this.I == bl && this.J == bl2 && this.E == this.G && this.F == this.H && com.corrodinggames.rts.gameFramework.f.h(f2 *= this.e.bQ.uiRenderScale, this.P) && com.corrodinggames.rts.gameFramework.f.h(f3, this.Q)) {
                return;
            }
            int n7 = n3;
            int n8 = n4;
    ...
    public void a(String string, boolean bl) {
        ...
        if (!string.startsWith("Loading units ")) {
            com.corrodinggames.rts.gameFramework.l.e("--Now loading:" + string);
            bl2 = false;
        }
        if (bl) {
            this.N = this.M;
    ...
    public void a(GameContainer gameContainer, Graphics graphics) {
        ...
        string = com.corrodinggames.rts.gameFramework.f.e("    " + string, 17);
    ...
    public void render(GameContainer gameContainer, Graphics graphics) {
        ...
        boolean bl3 = this.e.bT.ae.a();
        boolean bl4 = bl = this.e.bl && this.e.bT.af.a();
        if (bl) {
            bl3 = true;
        }
        if (this.e.bG) {
            ...
            this.t = 0;
            if (!com.corrodinggames.rts.gameFramework.l.aB && bl2) {
                this.b((e)object2);
            }
        } else {
            this.e.bX.b(f3);
    ...
    public void a(Graphics graphics, boolean bl) {
        ...
        try {
            ...
            String string2 = "screenshot_" + com.corrodinggames.rts.gameFramework.f.a("d MMM yyyy HH.mm.ss") + ".png";
            ...
            if (bl) {
                ...
                y2.a(this.Y.a, new File(string3));
                com.corrodinggames.rts.gameFramework.l.f(null, "Saving large screenshot: " + string2);
                return;
            }
            ...
            com.corrodinggames.rts.gameFramework.l.f(null, "Saving screenshot: " + string2);
            u$1 u$1 = new u$1(this, string3, byteArrayOutputStream, string2);
