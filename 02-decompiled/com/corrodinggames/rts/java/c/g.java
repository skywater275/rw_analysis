...
public class g {
    ...
    public void a(com.corrodinggames.rts.gameFramework.i.b b2, String string, boolean bl) {
        l.e("workshop: " + string);
        if (bl) {
            l.B().i(string);
        }
    ...
    public boolean a(com.corrodinggames.rts.gameFramework.i.b b2) {
        ...
        String string = b2.p();
        if (string != null && !com.corrodinggames.rts.gameFramework.e.a.i(string)) {
    ...
    public void d() {
        ...
        for (SteamPublishedFileID steamPublishedFileID : steamPublishedFileIDArray) {
            ...
            for (Object object2 : collection) {
                if (object2 == SteamUGC$ItemState.None) continue;
                string2 = string2 == null ? "" + (Object)object2 : string2 + ", " + (Object)object2;
                if (object2 == SteamUGC$ItemState.Downloading) {
                    bl2 = true;
                }
                if (object2 == SteamUGC$ItemState.DownloadPending) {
                    bl2 = true;
                    bl3 = true;
                }
                if (object2 == SteamUGC$ItemState.Installed) {
                    bl = true;
                }
                if (object2 == SteamUGC$ItemState.NeedsUpdate) {
                    bl4 = true;
                }
                if (object2 != SteamUGC$ItemState.Subscribed) continue;
                bl5 = true;
            }
            ...
            if (bl) {
                ...
                if (bl3) {
                    ...
                    if (this.d.getItemDownloadInfo(steamPublishedFileID, steamUGC$ItemDownloadInfo)) {
                        ...
                        string5 = string5 + " " + com.corrodinggames.rts.gameFramework.f.c(d2 * 100.0) + "%";
                    }
                }
            }
            boolean bl6 = true;
            ...
            com.corrodinggames.rts.gameFramework.i.b b2 = l2.bZ.a(string3, string3, string4, string, bl6, bl7, bl8, n3);
            if (b2.s == null) {
                b2.t = object2;
            }
            if (string5 == null && bl4) {
