...
implements d {
    ...
    public static void a(ArrayList arrayList, int n2) {
        ...
        arrayList.add(new v(com.corrodinggames.rts.game.units.ar.J, 1, 7));
        arrayList.add(new v(com.corrodinggames.rts.game.units.ar.y, 1, 8));
        arrayList.add(new v(com.corrodinggames.rts.game.units.ar.B, 1, 9));
    }
