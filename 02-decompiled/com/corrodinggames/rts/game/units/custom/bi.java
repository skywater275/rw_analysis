...
public class bi {
    ...
    public static bi a(l l2, ab ab2, String string, String string2, bi bi2) {
    ...
    public static bi a(l l2, String string, String string2, String string3, boolean bl) {
        if (l2 == null) {
    ...
    public static bi b(l l2, String string, String string2, String string3, boolean bl) {
        int n2;
        bi bi2 = new bi();
        ...
        for (String string4 : arrayList) {
            ...
            x x2 = l2.b(string4, string3, string2);
            bk bk2 = new bk(x2);
            if (bi2.a == null) {
                bi2.a = new m();
            }
    ...
    public void a(float f2, float f3, float f4, float f5, am am2, m m2, boolean bl, int n2, f f6, am am3) {
        if (this.a == null || this.a.size() == 0) {
            return;
        }
        int n3 = 0;
