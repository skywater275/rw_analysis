...
public class VariableScope {
        ...
        if (variableScope$VariableData instanceof VariableScope$VariableDataUnit) {
            ...
            if (variableScope$VariableDataArray instanceof VariableScope$VariableDataBoolArray) {
                ...
                for (int i = 0; i < variableScope$VariableDataUnitArray.size; ++i) {
                    am am3 = variableScope$VariableDataUnitArray.dataArray[i];
    ...
    public static VariableScope$VariableData readInDynamicData(k k2) {
        ...
        if (logicBoolean$ReturnType == LogicBoolean$ReturnType.boolArray || logicBoolean$ReturnType == LogicBoolean$ReturnType.numberArray || logicBoolean$ReturnType == LogicBoolean$ReturnType.unitArray) {
            ...
            if (logicBoolean$ReturnType == LogicBoolean$ReturnType.boolArray) {
                ...
                for (int i = 0; i < n2; ++i) {
                    variableScope$VariableDataBoolArray.setBooleanIndex(i, k2.e());
                }
            ...
            if (logicBoolean$ReturnType == LogicBoolean$ReturnType.numberArray) {
                ...
                for (int i = 0; i < n2; ++i) {
                    variableScope$VariableDataNumberArray.setNumberIndex(i, k2.g());
                }
    ...
    public static VariableScope$MemoryWriter createGenericKeyValueWriter(String string, l l2, String string2, String string3) {
        try {
    ...
    public static VariableScope$MemoryWriter createMemoryWriter(String string, l l2, String string2, String string3) {
        try {
            VariableScope$MemoryWriter variableScope$MemoryWriter = new VariableScope$MemoryWriter();
    ...
    public static VariableScope$MemoryNames createMemoryNameList(String string, l l2, LogicBoolean$ReturnType logicBoolean$ReturnType, String string2, String string3) {
        try {
            VariableScope$MemoryWriter variableScope$MemoryWriter = new VariableScope$MemoryWriter();
            ...
            for (VariableScope$CachedWriter$WriterElement variableScope$CachedWriter$WriterElement : variableScope$MemoryWriter.writers) {
                ...
                if (variableScope$MemoryWriterFactory$MemoryWriterElement instanceof MemoryWriterFactory$MemoryWriterElementIndex) {
