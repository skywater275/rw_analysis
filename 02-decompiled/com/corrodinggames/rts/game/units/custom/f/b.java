...
public class b {
    ...
    public String a(l l2, ab ab2, String string, String string2) {
        string2 = string2.trim();
        boolean bl = this.b(string2);
        int n = 0;
        StringBuffer stringBuffer = new StringBuffer();
        Matcher matcher = com.corrodinggames.rts.game.units.custom.f.a.b.matcher(string2);
        while (matcher.find()) {
            if (++n > 100) {
                throw new bo("Too many loops while parsing");
            }
            String string3 = matcher.group(0);
            if (f.r(string3) || string3.equals("int") || string3.equals("cos") || string3.equals("sin") || string3.equals("sqrt")) continue;
            String string4 = this.b(l2, ab2, string, string3);
            if (bl && !f.r(string4)) {
        ...
        if (bl) {
            string2 = f.b(com.corrodinggames.rts.game.units.custom.f.b.a(string2));
        }
        return string2;
    }

    public String b(l l2, ab ab2, String string, String string2) {
        if (string2.contains(".")) {
            String string3;
            String[] stringArray = f.c(string2, '.');
        ...
        String string6 = this.b.a(string2);
        if (string6 != null) {
            return string6;
        }
        string6 = this.a.a(string2);
        if (string6 != null) {
            return string6;
        }
