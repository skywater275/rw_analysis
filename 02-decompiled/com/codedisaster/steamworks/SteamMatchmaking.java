...
extends SteamInterface {
    ...
    public boolean sendLobbyChatMsg(SteamID steamID, ByteBuffer byteBuffer, int n, int n2) {
    ...
    public int getLobbyChatEntry(SteamID steamID, int n, ChatEntry chatEntry, ByteBuffer byteBuffer) {
        int n2 = byteBuffer.position();
        int n3 = byteBuffer.limit() - n2;
        return this.getLobbyChatEntry(steamID, n, chatEntry, byteBuffer, n2, n3);
    }

    public int getLobbyChatEntry(SteamID steamID, int n, ChatEntry chatEntry, ByteBuffer byteBuffer, int n2, int n3) {
        if (!byteBuffer.isDirect()) {
            throw new SteamException("Direct buffer required!");
        }
