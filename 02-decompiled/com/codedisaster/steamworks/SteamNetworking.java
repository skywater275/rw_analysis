...
extends SteamInterface {
    ...
    public boolean sendP2PPacket(SteamID steamID, ByteBuffer byteBuffer, SteamNetworking$P2PSend p2PSend, int n) {
        int n2 = byteBuffer.position();
        int n3 = byteBuffer.limit() - n2;
        return this.sendP2PPacket(steamID, byteBuffer, n2, n3, p2PSend, n);
    }

    public boolean sendP2PPacket(SteamID steamID, ByteBuffer byteBuffer, int n, int n2, SteamNetworking$P2PSend steamNetworking$P2PSend, int n3) {
    ...
    public int readP2PPacket(SteamID steamID, ByteBuffer byteBuffer, int n) {
        int n2 = byteBuffer.position();
        int n3 = byteBuffer.limit() - n2;
        return this.readP2PPacket(steamID, byteBuffer, n2, n3, n);
    }

    public int readP2PPacket(SteamID steamID, ByteBuffer byteBuffer, int n, int n2, int n3) {
        if (!byteBuffer.isDirect()) {
            throw new SteamException("Direct buffer required!");
        }
        if (byteBuffer.capacity() < n + n2) {
