...
public class SteamGameServerAPI {
    ...
    public static boolean init(int n, short s, short s2, short s3, SteamGameServerAPI$ServerMode serverMode, String string) {
        return SteamGameServerAPI.init(null, n, s, s2, s3, serverMode, string);
    }

    public static boolean init(String string, int n, short s, short s2, short s3, SteamGameServerAPI$ServerMode steamGameServerAPI$ServerMode, String string2) {
